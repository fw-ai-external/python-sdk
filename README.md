...
> repository is auto-generated from the Fireworks REST API spec and should
> **not** be referenced or modified when working on training features. See
> [`src/fireworks/training/README.md`](src/fireworks/training/README.md) for
> training-specific documentation.
