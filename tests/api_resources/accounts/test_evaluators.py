...
class TestEvaluators:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_build_log_endpoint(self, client: FireworksAI) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_build_log_endpoint_with_all_params(self, client: FireworksAI) -> None:
        evaluator = client.accounts.evaluators.get_build_log_endpoint(
            evaluator_id="evaluator_id",
            account_id="account_id",
            read_mask="readMask",
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_build_log_endpoint(self, client: FireworksAI) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_get_build_log_endpoint(self, client: FireworksAI) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_get_build_log_endpoint(self, client: FireworksAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
...
class TestAsyncEvaluators:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_build_log_endpoint(self, async_client: AsyncFireworksAI) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_build_log_endpoint_with_all_params(self, async_client: AsyncFireworksAI) -> None:
        evaluator = await async_client.accounts.evaluators.get_build_log_endpoint(
            evaluator_id="evaluator_id",
            account_id="account_id",
            read_mask="readMask",
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_get_build_log_endpoint(self, async_client: AsyncFireworksAI) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_get_build_log_endpoint(self, async_client: AsyncFireworksAI) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_get_build_log_endpoint(self, async_client: AsyncFireworksAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
