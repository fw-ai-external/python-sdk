...
class TestNodePoolBindings:
    ...
    def test_method_create(self, client: FireworksAI) -> None:
        ...
        assert_matches_type(GatewayNodePoolBinding, node_pool_binding, path=["response"])
    ...
    def test_raw_response_create(self, client: FireworksAI) -> None:
        ...
        node_pool_binding = response.parse()
        assert_matches_type(GatewayNodePoolBinding, node_pool_binding, path=["response"])
    ...
    def test_method_list(self, client: FireworksAI) -> None:
        ...
        assert_matches_type(NodePoolBindingListResponse, node_pool_binding, path=["response"])
...
class TestAsyncNodePoolBindings:
    ...
    async def test_raw_response_create(self, async_client: AsyncFireworksAI) -> None:
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        node_pool_binding = await response.parse()
        assert_matches_type(GatewayNodePoolBinding, node_pool_binding, path=["response"])
