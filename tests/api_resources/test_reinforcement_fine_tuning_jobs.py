...
class TestReinforcementFineTuningJobs:
    ...
    def test_method_create(self, client: Fireworks) -> None:
        ...
        assert_matches_type(ReinforcementFineTuningJobCreateResponse, reinforcement_fine_tuning_job, path=["response"])
    ...
    def test_streaming_response_create(self, client: Fireworks) -> None:
        with client.reinforcement_fine_tuning_jobs.with_streaming_response.create(
            ...
            reinforcement_fine_tuning_job = response.parse()
            assert_matches_type(
                ReinforcementFineTuningJobCreateResponse, reinforcement_fine_tuning_job, path=["response"]
            )
    ...
    def test_method_list(self, client: Fireworks) -> None:
        ...
        assert_matches_type(ReinforcementFineTuningJobListResponse, reinforcement_fine_tuning_job, path=["response"])
    ...
    def test_streaming_response_list(self, client: Fireworks) -> None:
        with client.reinforcement_fine_tuning_jobs.with_streaming_response.list(
            ...
            reinforcement_fine_tuning_job = response.parse()
            assert_matches_type(
                ReinforcementFineTuningJobListResponse, reinforcement_fine_tuning_job, path=["response"]
            )
    ...
    def test_method_get(self, client: Fireworks) -> None:
        ...
        assert_matches_type(ReinforcementFineTuningJobGetResponse, reinforcement_fine_tuning_job, path=["response"])
