...
class TestValidateModelConfig:
    ...
    @parametrize
    def test_method_validate(self, client: FireworksAI) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_validate_with_all_params(self, client: FireworksAI) -> None:
        validate_model_config = client.validate_model_config.validate(
            config_json="configJson",
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_validate(self, client: FireworksAI) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_validate(self, client: FireworksAI) -> None:
...
class TestAsyncValidateModelConfig:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_validate(self, async_client: AsyncFireworksAI) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_validate_with_all_params(self, async_client: AsyncFireworksAI) -> None:
        validate_model_config = await async_client.validate_model_config.validate(
            config_json="configJson",
            tokenizer_config_json="tokenizerConfigJson",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_validate(self, async_client: AsyncFireworksAI) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_validate(self, async_client: AsyncFireworksAI) -> None:
