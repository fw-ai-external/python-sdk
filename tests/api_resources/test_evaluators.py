...
class TestEvaluators:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_preview(self, client: Fireworks) -> None:
        evaluator = client.evaluators.preview(
            account_id="account_id",
            evaluator={},
            sample_data=["string"],
        )
        assert_matches_type(EvaluatorPreviewResponse, evaluator, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_preview_with_all_params(self, client: Fireworks) -> None:
        evaluator = client.evaluators.preview(
            account_id="account_id",
            evaluator={
                "commit_hash": "commitHash",
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_preview(self, client: Fireworks) -> None:
        response = client.evaluators.with_raw_response.preview(
            account_id="account_id",
            evaluator={},
            sample_data=["string"],
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_preview(self, client: Fireworks) -> None:
        with client.evaluators.with_streaming_response.preview(
            account_id="account_id",
            evaluator={},
            sample_data=["string"],
        ) as response:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_preview(self, client: Fireworks) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.evaluators.with_raw_response.preview(
                account_id="",
                evaluator={},
                sample_data=["string"],
            )
...
class TestAsyncEvaluators:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_preview(self, async_client: AsyncFireworks) -> None:
        evaluator = await async_client.evaluators.preview(
            account_id="account_id",
            evaluator={},
            sample_data=["string"],
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_preview_with_all_params(self, async_client: AsyncFireworks) -> None:
        evaluator = await async_client.evaluators.preview(
            account_id="account_id",
            evaluator={
                "commit_hash": "commitHash",
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_preview(self, async_client: AsyncFireworks) -> None:
        response = await async_client.evaluators.with_raw_response.preview(
            account_id="account_id",
            evaluator={},
            sample_data=["string"],
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_preview(self, async_client: AsyncFireworks) -> None:
        async with async_client.evaluators.with_streaming_response.preview(
            account_id="account_id",
            evaluator={},
            sample_data=["string"],
        ) as response:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_preview(self, async_client: AsyncFireworks) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.evaluators.with_raw_response.preview(
                account_id="",
                evaluator={},
                sample_data=["string"],
            )
