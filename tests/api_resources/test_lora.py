...
from fireworks.pagination import SyncCursorDeployedModels, AsyncCursorDeployedModels
...
class TestLora:
    ...
    def test_method_list(self, client: Fireworks) -> None:
        ...
        assert_matches_type(SyncCursorDeployedModels[DeployedModel], lora, path=["response"])
...
class TestAsyncLora:
    ...
    async def test_method_list(self, async_client: AsyncFireworks) -> None:
        ...
        assert_matches_type(AsyncCursorDeployedModels[DeployedModel], lora, path=["response"])
