...
class TrainerJobConfig:
    ...
    * **Manual path** (``training_shape_ref`` is ``None``): all fields
    ...
    """When set, the parent training job ID that manages billing for this trainer.
    This trainer emits no billing events. Set by the control plane when launched
    via TrainingJobWorkflow; not intended for end users."""
