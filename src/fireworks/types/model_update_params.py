...
__all__ = ["ModelUpdateParams", "BaseModelDetails", "ConversationConfig", "DeprecationDate", "PeftDetails"]


class ModelUpdateParams(TypedDict, total=False):
    account_id: Required[str]

    base_model_details: Annotated[BaseModelDetails, PropertyInfo(alias="baseModelDetails")]
    ...
    conversation_config: Annotated[ConversationConfig, PropertyInfo(alias="conversationConfig")]
    ...
    deprecation_date: Annotated[DeprecationDate, PropertyInfo(alias="deprecationDate")]
    """
    ...
    peft_details: Annotated[PeftDetails, PropertyInfo(alias="peftDetails")]
...
class BaseModelDetails(TypedDict, total=False):
...
class DeprecationDate(TypedDict, total=False):
    day: int
    """Day of a month.
...
class PeftDetails(TypedDict, total=False):
