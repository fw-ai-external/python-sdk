...
__all__ = ["ChatCompletionChunk", "Choice", "ChoiceDelta", "ChoiceDeltaInternalContent", "ChoiceLogprobs"]


class ChoiceDeltaInternalContent(BaseModel):
    """
    Fireworks extension: internal model content surfaced inside the streaming
    delta when ``stream_options.include_internal_content=true``.
    """

    token_id: Optional[List[int]] = None
    """Token IDs for this chunk's delta (when include_internal_content=true)"""
...
class ChoiceDelta(BaseModel):
    ...
    internal_content: Optional[ChoiceDeltaInternalContent] = None
    """
    Fireworks extension: internal model content surfaced inside the streaming delta
    when `stream_options.include_internal_content=true`.
    """
