...
__all__ = [
    ...
    "SyncCursorDeployedModels",
    "AsyncCursorDeployedModels",
...
class SyncCursorDeployedModels(BaseSyncPage[_T], BasePage[_T], Generic[_T]):
...
class AsyncCursorDeployedModels(BaseAsyncPage[_T], BasePage[_T], Generic[_T]):
    deployed_models: List[_T] = FieldInfo(alias="deployedModels")
    next_page_token: Optional[str] = FieldInfo(alias="nextPageToken", default=None)
