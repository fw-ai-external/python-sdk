...
__all__ = [
    ...
    "ReinforcementFineTuningJobInferenceParameters",
    "ReinforcementFineTuningJobStatus",
    "ReinforcementFineTuningJobTrainingConfig",
    "ReinforcementFineTuningJobWandbConfig",
]


class ReinforcementFineTuningJobInferenceParameters(BaseModel):
...
class ReinforcementFineTuningJobStatus(BaseModel):
    code: Optional[
        Literal[
            "OK",
            "CANCELLED",
...
class ReinforcementFineTuningJobTrainingConfig(BaseModel):
...
class ReinforcementFineTuningJobWandbConfig(BaseModel):
...
class ReinforcementFineTuningJob(BaseModel):
    ...
    inference_parameters: Optional[ReinforcementFineTuningJobInferenceParameters] = FieldInfo(
        alias="inferenceParameters", default=None
    )
    """BIJ parameters."""
    ...
    status: Optional[ReinforcementFineTuningJobStatus] = None

    training_config: Optional[ReinforcementFineTuningJobTrainingConfig] = FieldInfo(
        alias="trainingConfig", default=None
    )
    """Common training configurations."""

    wandb_config: Optional[ReinforcementFineTuningJobWandbConfig] = FieldInfo(alias="wandbConfig", default=None)
