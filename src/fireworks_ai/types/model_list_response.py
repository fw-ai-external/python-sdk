...
class ModelBaseModelDetails(BaseModel):
...
class ModelDeployedModelRef(BaseModel):
...
class ModelDeprecationDate(BaseModel):
...
class ModelPeftDetails(BaseModel):
...
class Model(BaseModel):
    base_model_details: Optional[ModelBaseModelDetails] = FieldInfo(alias="baseModelDetails", default=None)
    ...
    conversation_config: Optional[ModelConversationConfig] = FieldInfo(alias="conversationConfig", default=None)
    ...
    deployed_model_refs: Optional[List[ModelDeployedModelRef]] = FieldInfo(alias="deployedModelRefs", default=None)
    """Populated from GetModel API call only."""

    deprecation_date: Optional[ModelDeprecationDate] = FieldInfo(alias="deprecationDate", default=None)
    """
    ...
    peft_details: Optional[ModelPeftDetails] = FieldInfo(alias="peftDetails", default=None)
