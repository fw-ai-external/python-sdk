...
from .gateway_batch_inference_job import GatewayBatchInferenceJob

__all__ = ["BatchInferenceJobListResponse"]


class BatchInferenceJobListResponse(BaseModel):
    batch_inference_jobs: Optional[List[GatewayBatchInferenceJob]] = FieldInfo(alias="batchInferenceJobs", default=None)
