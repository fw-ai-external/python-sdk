...
from .date_type_param import DateTypeParam
...
class ModelUpdateParams(TypedDict, total=False):
    ...
    deprecation_date: Annotated[DateTypeParam, PropertyInfo(alias="deprecationDate")]
    """
    ...
    snapshot_type: Annotated[ModelSnapshot, PropertyInfo(alias="snapshotType")]
