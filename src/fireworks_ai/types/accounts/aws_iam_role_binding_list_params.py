...
__all__ = ["AwsIamRoleBindingListParams"]


class AwsIamRoleBindingListParams(TypedDict, total=False):
    filter: str
    """Only bindings satisfying the provided filter (if specified) will be returned.
    ...
    """
    A page token, received from a previous ListAwsIamRoleBindings call. Provide this
