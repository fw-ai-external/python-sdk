...
class SnapshotListParams(TypedDict, total=False):
    filter: str
    """Only snapshots satisfying the provided filter (if specified) will be returned.
    ...
    parameters provided to ListEnvironments must match the call that provided the
    page token.
    """
