...
__all__ = ["SupervisedFineTuningJobSupervisedFineTuningJobsParams", "HiddenStatesGenConfig"]


class SupervisedFineTuningJobSupervisedFineTuningJobsParams(TypedDict, total=False):
