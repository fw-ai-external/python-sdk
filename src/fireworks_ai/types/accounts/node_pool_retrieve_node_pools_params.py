...
__all__ = ["NodePoolRetrieveNodePoolsParams"]


class NodePoolRetrieveNodePoolsParams(TypedDict, total=False):
    filter: str
    """Only node pools satisfying the provided filter (if specified) will be returned.
    ...
    """The maximum number of node pools to return.
    ...
    parameters provided to ListNodePools must match the call that provided the page
    token.
    """
