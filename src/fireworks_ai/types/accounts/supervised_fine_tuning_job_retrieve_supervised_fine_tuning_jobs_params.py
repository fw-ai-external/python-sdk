...
__all__ = ["SupervisedFineTuningJobRetrieveSupervisedFineTuningJobsParams"]


class SupervisedFineTuningJobRetrieveSupervisedFineTuningJobsParams(TypedDict, total=False):
    filter: str
