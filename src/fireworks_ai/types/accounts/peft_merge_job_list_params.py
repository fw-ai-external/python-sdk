...
__all__ = ["PeftMergeJobListParams"]


class PeftMergeJobListParams(TypedDict, total=False):
    filter: str
    ...
    """The maximum number of peft merge jobs to return.
    ...
    """A page token, received from a previous ListPeftMergeJobs call.

    Provide this to retrieve the subsequent page. When paginating, all other
    parameters provided to ListPeftMergeJobs must match the call that provided the
    page token.
    """
