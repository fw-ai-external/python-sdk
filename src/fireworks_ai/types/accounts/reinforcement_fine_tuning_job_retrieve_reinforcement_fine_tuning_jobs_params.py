...
__all__ = ["ReinforcementFineTuningJobRetrieveReinforcementFineTuningJobsParams"]


class ReinforcementFineTuningJobRetrieveReinforcementFineTuningJobsParams(TypedDict, total=False):
    filter: str
