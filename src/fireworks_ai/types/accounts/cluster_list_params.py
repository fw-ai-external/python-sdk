...
class ClusterListParams(TypedDict, total=False):
    filter: str
    """Only clusters satisfying the provided filter (if specified) will be returned.
    ...
    parameters provided to ListClusters must match the call that provided the page
    token.
    """
