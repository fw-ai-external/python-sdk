...
class McpServerListParams(TypedDict, total=False):
    filter: str
    """Only mcp server satisfying the provided filter (if specified) will be returned.
    ...
    """The maximum number of mcp servers to return.
    ...
    """A page token, received from a previous ListMcpServers call.

    Provide this to retrieve the subsequent page. When paginating, all other
    parameters provided to ListMcpServers must match the call that provided the page
    token.
    """
