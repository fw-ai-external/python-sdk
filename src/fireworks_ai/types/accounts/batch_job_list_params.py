...
__all__ = ["BatchJobListParams"]


class BatchJobListParams(TypedDict, total=False):
    filter: str
    """Only batch jobs satisfying the provided filter (if specified) will be returned.
    ...
    order is by "create_time desc".
    """

    page_size: Annotated[int, PropertyInfo(alias="pageSize")]
    """The maximum number of batch jobs to return.
    ...
    parameters provided to ListBatchJobs must match the call that provided the page
    token.
    """
