...
__all__ = ["NodePoolBindingListParams"]


class NodePoolBindingListParams(TypedDict, total=False):
    filter: str
    ...
    """
    A page token, received from a previous ListNodePoolBindings call. Provide this
