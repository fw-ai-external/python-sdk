...
__all__ = ["ReinforcementFineTuningJobGetResponse", "InferenceParameters", "Status", "TrainingConfig", "WandbConfig"]
...
class ReinforcementFineTuningJobGetResponse(BaseModel):
    dataset: str
