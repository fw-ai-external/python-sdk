...
class DeploymentAutoscalingPolicy(BaseModel):
...
class DeploymentAutoTune(BaseModel):
...
class Deployment(BaseModel):
    ...
    autoscaling_policy: Optional[DeploymentAutoscalingPolicy] = FieldInfo(alias="autoscalingPolicy", default=None)

    auto_tune: Optional[DeploymentAutoTune] = FieldInfo(alias="autoTune", default=None)
    ...
    placement: Optional[DeploymentPlacement] = None
    """
