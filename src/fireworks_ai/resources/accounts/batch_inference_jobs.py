...
from ...types.accounts import (
    ...
    batch_inference_job_retrieve_params,
)
from ...types.accounts.deployment_precision import DeploymentPrecision
from ...types.accounts.gateway_batch_inference_job import GatewayBatchInferenceJob
from ...types.accounts.batch_inference_job_list_response import BatchInferenceJobListResponse
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=GatewayBatchInferenceJob,
        )
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform(
                    {"read_mask": read_mask}, batch_inference_job_retrieve_params.BatchInferenceJobRetrieveParams
                ),
            ),
            cast_to=GatewayBatchInferenceJob,
        )
