...
from ...types.accounts import (
    ...
    model_create_version_params,
    model_validate_upload_params,
    model_get_upload_endpoint_params,
    model_get_download_endpoint_params,
)
from ...types.accounts.model import Model
from ...types.accounts.model_kind import ModelKind
from ...types.accounts.model_param import ModelParam
from ...types.accounts.model_version import ModelVersion
from ...types.accounts.model_snapshot import ModelSnapshot
from ...types.accounts.date_type_param import DateTypeParam
from ...types.accounts.peft_details_param import PeftDetailsParam
from ...types.accounts.model_list_response import ModelListResponse
from ...types.accounts.deployment_precision import DeploymentPrecision
from ...types.accounts.model_import_response import ModelImportResponse
from ...types.accounts.base_model_details_param import BaseModelDetailsParam
from ...types.accounts.conversation_config_param import ConversationConfigParam
from ...types.accounts.model_count_versions_response import ModelCountVersionsResponse
from ...types.accounts.model_get_upload_endpoint_response import ModelGetUploadEndpointResponse
from ...types.accounts.model_get_download_endpoint_response import ModelGetDownloadEndpointResponse
...
class ModelsResource(SyncAPIResource):
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"read_mask": read_mask}, model_retrieve_params.ModelRetrieveParams),
            ),
            cast_to=Model,
        )
    ...
    def update(
        ...
        *,
        ...
        deprecation_date: DateTypeParam | Omit = omit,
        ...
        snapshot_type: ModelSnapshot | Omit = omit,
    ...
    def count_versions(
        ...
        *,
        ...
        if not model_id:
            raise ValueError(f"Expected a non-empty value for `model_id` but received {model_id!r}")
        return self._get(
            f"/v1/accounts/{account_id}/models/{model_id}/versions:count",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ModelCountVersionsResponse,
        )
    ...
    def create_version(
        ...
        *,
        ...
        if not model_id:
            raise ValueError(f"Expected a non-empty value for `model_id` but received {model_id!r}")
        return self._post(
            f"/v1/accounts/{account_id}/models/{model_id}/versions",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"version_id": version_id}, model_create_version_params.ModelCreateVersionParams),
            ),
    ...
    def import_(
        ...
        *,
        account_id: str,
        aws_s3_source: model_import_params.AwsS3Source | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        Args:
          aws_s3_source: AWS S3 source details. Must be set when importing from AWS S3.
        ...
        if not model_id:
            raise ValueError(f"Expected a non-empty value for `model_id` but received {model_id!r}")
        return self._post(
            f"/v1/accounts/{account_id}/models/{model_id}:import",
            body=maybe_transform({"aws_s3_source": aws_s3_source}, model_import_params.ModelImportParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ModelImportResponse,
        )
...
class AsyncModelsResource(AsyncAPIResource):
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"read_mask": read_mask}, model_retrieve_params.ModelRetrieveParams),
            ),
            cast_to=Model,
        )
        ...
        *,
        ...
        return await self._post(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"version_id": version_id}, model_create_version_params.ModelCreateVersionParams
                ),
            ),
            cast_to=ModelVersion,
        )
    ...
    async def import_(
        ...
        *,
        ...
        return await self._post(
            f"/v1/accounts/{account_id}/models/{model_id}:import",
            body=await async_maybe_transform({"aws_s3_source": aws_s3_source}, model_import_params.ModelImportParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ModelImportResponse,
...
class ModelsResourceWithRawResponse:
    def __init__(self, models: ModelsResource) -> None:
        ...
        self.count_versions = to_raw_response_wrapper(
            models.count_versions,
        )
...
class AsyncModelsResourceWithRawResponse:
    def __init__(self, models: AsyncModelsResource) -> None:
        ...
        self.count_versions = async_to_raw_response_wrapper(
            models.count_versions,
        )
...
class ModelsResourceWithStreamingResponse:
    def __init__(self, models: ModelsResource) -> None:
        ...
        self.count_versions = to_streamed_response_wrapper(
            models.count_versions,
        )
...
class AsyncModelsResourceWithStreamingResponse:
    def __init__(self, models: AsyncModelsResource) -> None:
        ...
        self.count_versions = async_to_streamed_response_wrapper(
            models.count_versions,
        )
