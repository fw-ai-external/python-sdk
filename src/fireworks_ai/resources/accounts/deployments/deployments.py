...
from ....types.accounts import (
    ...
    deployment_get_metrics_params,
)
from ....types.accounts.gateway_deployment import GatewayDeployment
from ....types.accounts.deployment_precision import DeploymentPrecision
from ....types.accounts.gateway_auto_tune_param import GatewayAutoTuneParam
from ....types.accounts.gateway_placement_param import GatewayPlacementParam
from ....types.accounts.deployment_list_response import DeploymentListResponse
from ....types.accounts.gateway_accelerator_type import GatewayAcceleratorType
from ....types.accounts.gateway_direct_route_type import GatewayDirectRouteType
from ....types.accounts.deployment_get_metrics_response import DeploymentGetMetricsResponse
from ....types.accounts.gateway_autoscaling_policy_param import GatewayAutoscalingPolicyParam
from ....types.accounts.deployment_get_termination_message_response import DeploymentGetTerminationMessageResponse
...
class DeploymentsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        autoscaling_policy: GatewayAutoscalingPolicyParam | Omit = omit,
        auto_tune: GatewayAutoTuneParam | Omit = omit,
        deployment_shape: str | Omit = omit,
        deployment_template: str | Omit = omit,
        description: str | Omit = omit,
        direct_route_api_keys: SequenceNotStr[str] | Omit = omit,
        direct_route_type: GatewayDirectRouteType | Omit = omit,
        ...
        placement: GatewayPlacementParam | Omit = omit,
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"read_mask": read_mask}, deployment_retrieve_params.DeploymentRetrieveParams),
            ),
            cast_to=GatewayDeployment,
        )
    ...
    def get_metrics(
        ...
        *,
        ...
        Args:
          ...
          time_range: The time range to fetch metrics for (e.g. "1m", "10m", "2h"). Defaults to 10m.
        ...
        if not deployment_id:
            raise ValueError(f"Expected a non-empty value for `deployment_id` but received {deployment_id!r}")
        return self._get(
            f"/v1/accounts/{account_id}/deployments/{deployment_id}:metrics",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=maybe_transform(
                    ...
                    deployment_get_metrics_params.DeploymentGetMetricsParams,
                ),
            ),
            cast_to=DeploymentGetMetricsResponse,
        )
    ...
    def get_termination_message(
        ...
        *,
        ...
        if not deployment_id:
            raise ValueError(f"Expected a non-empty value for `deployment_id` but received {deployment_id!r}")
        return self._get(
            f"/v1/accounts/{account_id}/deployments/{deployment_id}/terminationMessage",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=DeploymentGetTerminationMessageResponse,
        )
...
class AsyncDeploymentsResource(AsyncAPIResource):
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=await async_maybe_transform(
                    {"read_mask": read_mask}, deployment_retrieve_params.DeploymentRetrieveParams
                ),
            ),
            cast_to=GatewayDeployment,
        )
    ...
    async def get_termination_message(
        self,
        deployment_id: str,
        *,
        account_id: str,
...
class DeploymentsResourceWithRawResponse:
    def __init__(self, deployments: DeploymentsResource) -> None:
        ...
        self.get_metrics = to_raw_response_wrapper(
            deployments.get_metrics,
        )
        self.get_termination_message = to_raw_response_wrapper(
            deployments.get_termination_message,
        )
    ...
    def ledger(self) -> LedgerResourceWithRawResponse:
        return LedgerResourceWithRawResponse(self._deployments.ledger)
...
class AsyncDeploymentsResourceWithRawResponse:
    def __init__(self, deployments: AsyncDeploymentsResource) -> None:
        ...
        self.get_termination_message = async_to_raw_response_wrapper(
            deployments.get_termination_message,
        )
    ...
    def ledger(self) -> AsyncLedgerResourceWithRawResponse:
        return AsyncLedgerResourceWithRawResponse(self._deployments.ledger)
...
class DeploymentsResourceWithStreamingResponse:
    def __init__(self, deployments: DeploymentsResource) -> None:
        ...
        self.get_termination_message = to_streamed_response_wrapper(
            deployments.get_termination_message,
        )
    ...
    def ledger(self) -> LedgerResourceWithStreamingResponse:
        return LedgerResourceWithStreamingResponse(self._deployments.ledger)
...
class AsyncDeploymentsResourceWithStreamingResponse:
    def __init__(self, deployments: AsyncDeploymentsResource) -> None:
        ...
        self.get_termination_message = async_to_streamed_response_wrapper(
            deployments.get_termination_message,
        )
    ...
    def ledger(self) -> AsyncLedgerResourceWithStreamingResponse:
        return AsyncLedgerResourceWithStreamingResponse(self._deployments.ledger)
