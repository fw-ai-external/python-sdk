...
from ....types.accounts import (
    ...
    user_api_keys_delete_params,
)
from ....types.accounts.user import User
from ....types.accounts.user_list_response import UserListResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"read_mask": read_mask}, user_retrieve_params.UserRetrieveParams),
            ),
            cast_to=User,
        )
    ...
    def api_keys_delete(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"key_id": key_id}, user_api_keys_delete_params.UserAPIKeysDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
...
class AsyncUsersResource(AsyncAPIResource):
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"read_mask": read_mask}, user_retrieve_params.UserRetrieveParams),
            ),
            cast_to=User,
        )
    ...
    async def api_keys_delete(
        ...
        *,
        ...
        return await self._post(
            f"/v1/accounts/{account_id}/users/{user_id}/apiKeys:delete",
            body=await async_maybe_transform({"key_id": key_id}, user_api_keys_delete_params.UserAPIKeysDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
