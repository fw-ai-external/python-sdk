...
from ...types.accounts import (
    GatewayRegion,
    supervised_fine_tuning_job_retrieve_params,
    supervised_fine_tuning_job_supervised_fine_tuning_jobs_params,
    supervised_fine_tuning_job_retrieve_supervised_fine_tuning_jobs_params,
)
from ...types.accounts.gateway_region import GatewayRegion
from ...types.accounts.gateway_wandb_config_param import GatewayWandbConfigParam
from ...types.accounts.gateway_supervised_fine_tuning_job import GatewaySupervisedFineTuningJob
from ...types.accounts.supervised_fine_tuning_job_retrieve_supervised_fine_tuning_jobs_response import (
...
class SupervisedFineTuningJobsResource(SyncAPIResource):
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"read_mask": read_mask},
                    supervised_fine_tuning_job_retrieve_params.SupervisedFineTuningJobRetrieveParams,
                ),
            ),
            cast_to=GatewaySupervisedFineTuningJob,
        )
    ...
    def retrieve_supervised_fine_tuning_jobs(
        self,
        account_id: str,
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    supervised_fine_tuning_job_retrieve_supervised_fine_tuning_jobs_params.SupervisedFineTuningJobRetrieveSupervisedFineTuningJobsParams,
                ),
            ),
            cast_to=SupervisedFineTuningJobRetrieveSupervisedFineTuningJobsResponse,
        )
    ...
    def supervised_fine_tuning_jobs(
        ...
        *,
        ...
        hidden_states_gen_config: supervised_fine_tuning_job_supervised_fine_tuning_jobs_params.HiddenStatesGenConfig
        | Omit = omit,
        ...
        region: GatewayRegion | Omit = omit,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                supervised_fine_tuning_job_supervised_fine_tuning_jobs_params.SupervisedFineTuningJobSupervisedFineTuningJobsParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
...
class AsyncSupervisedFineTuningJobsResource(AsyncAPIResource):
    ...
    async def retrieve_supervised_fine_tuning_jobs(
        self,
        account_id: str,
        *,
        filter: str | Omit = omit,
    ...
    async def supervised_fine_tuning_jobs(
        self,
        account_id: str,
        *,
        dataset: str,
...
class SupervisedFineTuningJobsResourceWithRawResponse:
    def __init__(self, supervised_fine_tuning_jobs: SupervisedFineTuningJobsResource) -> None:
        ...
        self.retrieve = to_raw_response_wrapper(
            supervised_fine_tuning_jobs.retrieve,
        )
        self.delete = to_raw_response_wrapper(
            supervised_fine_tuning_jobs.delete,
        )
        self.retrieve_supervised_fine_tuning_jobs = to_raw_response_wrapper(
            supervised_fine_tuning_jobs.retrieve_supervised_fine_tuning_jobs,
        )
        self.supervised_fine_tuning_jobs = to_raw_response_wrapper(
            supervised_fine_tuning_jobs.supervised_fine_tuning_jobs,
        )
...
class AsyncSupervisedFineTuningJobsResourceWithRawResponse:
    def __init__(self, supervised_fine_tuning_jobs: AsyncSupervisedFineTuningJobsResource) -> None:
        ...
        self.retrieve_supervised_fine_tuning_jobs = async_to_raw_response_wrapper(
            supervised_fine_tuning_jobs.retrieve_supervised_fine_tuning_jobs,
        )
        self.supervised_fine_tuning_jobs = async_to_raw_response_wrapper(
            supervised_fine_tuning_jobs.supervised_fine_tuning_jobs,
        )
...
class SupervisedFineTuningJobsResourceWithStreamingResponse:
    def __init__(self, supervised_fine_tuning_jobs: SupervisedFineTuningJobsResource) -> None:
        ...
        self.retrieve_supervised_fine_tuning_jobs = to_streamed_response_wrapper(
            supervised_fine_tuning_jobs.retrieve_supervised_fine_tuning_jobs,
        )
        self.supervised_fine_tuning_jobs = to_streamed_response_wrapper(
            supervised_fine_tuning_jobs.supervised_fine_tuning_jobs,
        )
...
class AsyncSupervisedFineTuningJobsResourceWithStreamingResponse:
    def __init__(self, supervised_fine_tuning_jobs: AsyncSupervisedFineTuningJobsResource) -> None:
        ...
        self.retrieve_supervised_fine_tuning_jobs = async_to_streamed_response_wrapper(
            supervised_fine_tuning_jobs.retrieve_supervised_fine_tuning_jobs,
        )
        self.supervised_fine_tuning_jobs = async_to_streamed_response_wrapper(
            supervised_fine_tuning_jobs.supervised_fine_tuning_jobs,
        )
