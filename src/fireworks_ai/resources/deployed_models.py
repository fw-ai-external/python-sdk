...
from ..types.deployed_model_get_response import DeployedModelGetResponse
from ..types.deployed_model_list_response import DeployedModelListResponse
from ..types.deployed_model_create_response import DeployedModelCreateResponse
from ..types.deployed_model_update_response import DeployedModelUpdateResponse
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=DeployedModelCreateResponse,
        )
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            ...
            cast_to=DeployedModelUpdateResponse,
        )
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=DeployedModelGetResponse,
        )
