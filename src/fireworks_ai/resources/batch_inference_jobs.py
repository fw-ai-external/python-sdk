...
from ..types.batch_inference_job_get_response import BatchInferenceJobGetResponse
from ..types.batch_inference_job_list_response import BatchInferenceJobListResponse
from ..types.batch_inference_job_create_response import BatchInferenceJobCreateResponse
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=BatchInferenceJobCreateResponse,
        )
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=BatchInferenceJobGetResponse,
        )
