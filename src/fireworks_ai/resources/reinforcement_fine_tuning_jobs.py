...
from ..types.reinforcement_fine_tuning_job_get_response import ReinforcementFineTuningJobGetResponse
from ..types.reinforcement_fine_tuning_job_list_response import ReinforcementFineTuningJobListResponse
from ..types.reinforcement_fine_tuning_job_create_response import ReinforcementFineTuningJobCreateResponse
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=ReinforcementFineTuningJobCreateResponse,
        )
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=ReinforcementFineTuningJobGetResponse,
        )
