...
from ..types.supervised_fine_tuning_job_get_response import SupervisedFineTuningJobGetResponse
from ..types.supervised_fine_tuning_job_list_response import SupervisedFineTuningJobListResponse
from ..types.supervised_fine_tuning_job_create_response import SupervisedFineTuningJobCreateResponse
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=SupervisedFineTuningJobCreateResponse,
        )
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=SupervisedFineTuningJobGetResponse,
        )
