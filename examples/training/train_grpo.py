...
def main():
    ...
    # NOTE: Don't pass base_url to Fireworks() for chat completions — the SDK
    # handles the /inference prefix automatically when using the default URL.
    # For non-prod environments, set FIREWORKS_BASE_URL env var instead.
    from fireworks import Fireworks
